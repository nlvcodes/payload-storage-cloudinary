...
export const createDeleteHandler = (
...
): HandleDelete => async ({ collection, doc }) => {
  ...
  try {
    ...
    const publicId = docData.cloudinaryPublicId ||
    ...
    console.error(`[Cloudinary Delete] Failed to delete: ${error instanceof Error ? error.message : 'Unknown error'}`)
  }
}
